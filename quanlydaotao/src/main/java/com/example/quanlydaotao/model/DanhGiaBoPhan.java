...
public class DanhGiaBoPhan {
    ...
    @Column(name = "tendanhgia")
    @NotNull(message = "Tên đánh giá không được để trống!")
    ...
    public DanhGiaBoPhan(int maDiemDanhGia, DeCuongChiTiet maBoPhan, String tenDanhGia, float trongSo, String hinhThucDanhGia) {
    ...
    public String getTenDanhGia() { return tenDanhGia; }
    public void setTenDanhGia(String tenDanhGia) { this.tenDanhGia = tenDanhGia; }
