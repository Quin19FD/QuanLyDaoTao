...
public class GiangVien {
    ...
    @Column(name = "hockygiangday")
    @NotNull(message = "Học kỳ giảng dạy không được để trống!")
    @Min(value = 0, message = "Học kỳ giảng dạy không được âm!")
    private int hocKiGiangDay;
    ...
    public GiangVien(int maGV, String tenGV, String namSinh, String hocVi, int hocKiGiangDay, String congTacKhac, int tongCLC){
        this.maGV = maGV;
        this.tenGV = tenGV;
        this.namSinh = namSinh;
        this.hocVi = hocVi;
        this.hocKiGiangDay = hocKiGiangDay;
    ...
    public int getHocKiGiangDay() {
        return hocKiGiangDay;
    }

    public void setHocKiGiangDay(int hocKiGiangDay) {
        this.hocKiGiangDay = hocKiGiangDay;
    }
