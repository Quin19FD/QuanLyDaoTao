...
public class CTDaoTao {
    ...
    public CTDaoTao(int maCTDT, String tenCTDT, String bac, String loaiBang, String loaiHinhDaoTao, int thoiGian, int soTinToiThieu, String khoaQuanLy, String ngonNgu, String banHanh) {
        this.maCTDT = maCTDT;
